...
void getdata(bufferToggle bt) {
  ...
  //works for now 
  //would like to find a work around from using this str so i dont
...
int main() {
  ...
  int i = 0;
  int c;
  // used as a template to know how big the class is depending on diff size
  //so as to be able to initialize the correct amount later
  entry objT;
  // used to hold the character your on durring editing
  char cBuff[1];
